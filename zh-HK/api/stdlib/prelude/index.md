...
| [`PlotDisplay`](/zh-HK/api/stdlib/prelude/PlotDisplay) | 顯示繪圖選項（例如全部、無、僅價格）。 |
| [`PlotSimpleDisplay`](/zh-HK/api/stdlib/prelude/PlotSimpleDisplay) | 控制繪圖顯示的價格比例和圖表。 |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `color` | <code>series&nbsp;color</code> |  | 應用於 bar 的顏色。使用 `na` 保留默認顏色。 |
...
| `title` | <code>const&nbsp;string</code> | `na` | 標題顯示在樣式對話框中。 |
| `display` | <code>input&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/PlotSimpleDisplay">PlotSimpleDisplay</a></code> |  | 控制顏色可見的位置。 |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `color` | <code>series&nbsp;color</code> |  | 背景顏色。使用 `na` 表示透明。 |
| `offset` | <code>simple&nbsp;int</code> | `0` | 將背景顏色向左（負）或右（正）移動指定數量的 bars。 |
| `editable` | <code>input&nbsp;bool</code> | `true` | 如果為 true，則可以在樣式對話框中編輯該設定。 |
| `show_last` | <code>input&nbsp;int</code> | `na` | 如果設定，則僅填充最後 N 個 bars。 |
| `title` | <code>const&nbsp;string</code> | `na` | 標題顯示在樣式對話框中。 |
| `display` | <code>input&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/PlotSimpleDisplay">PlotSimpleDisplay</a></code> | `display.ALL` | 控制背景可見的位置。 |
...
| `timezone` | <code>string</code> | `syminfo.timezone` | 用於解釋的時區。默認為符號的時區。 |
...
| `color` | <code>series&nbsp;color</code> | `color.BLUE` | 填充顏​​色。 |
| `title` | <code>const&nbsp;string</code> | `na` | 標題顯示在樣式對話框中。 |
| `editable` | <code>input&nbsp;bool</code> | `true` | 如果為 true，則可以在樣式對話框中編輯填充。 |
| `fill_gaps` | <code>const&nbsp;bool</code> | `false` | 如果為真，則填補資料中的空白。 |
| `display` | <code>input&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/PlotSimpleDisplay">PlotSimpleDisplay</a></code> | `display.ALL` | 控制填充的可見位置。 |
...
| `top_color` | <code>series&nbsp;color</code> | `color.BLUE` | 漸變頂部的顏色。 |
| `bottom_color` | <code>series&nbsp;color</code> | `#3a3c42` | 漸變底部的顏色。 |
| `title` | <code>const&nbsp;string</code> | `na` | 標題顯示在樣式對話框中。 |
| `display` | <code>input&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/PlotSimpleDisplay">PlotSimpleDisplay</a></code> | `display.ALL` | 控制填充的可見位置。 |
| `fill_gaps` | <code>const&nbsp;bool</code> | `false` | 如果為真，則填補資料中的空白。 |
| `editable` | <code>input&nbsp;bool</code> | `true` | 如果為 true，則可以在樣式對話框中編輯填充。 |
...
| `title` | <code>const&nbsp;string</code> | `na` | 標題顯示在樣式對話框中。 |
| `color` | <code>input&nbsp;color</code> | `color.BLUE` | 線條顏色。 |
| `linestyle` | <code>input&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/HlineStyle">HlineStyle</a></code> | `HlineStyle.Dashed` | 線條樣式：<code>hLineStyle.Solid</code>、<code>hLineStyle.Dashed</code>、<code>hLineStyle.Dotted</code>。 |
| `linewidth` | <code>input&nbsp;int</code> | `1` | 線條的寬度（以像素 (1-4) 為單位）。 |
| `editable` | <code>input&nbsp;bool</code> | `true` | 如果為 true，則可以在樣式對話框中編輯該線。 |
| `display` | <code>input&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/PlotSimpleDisplay">PlotSimpleDisplay</a></code> | `display.ALL` | 控制線的可見位置。 |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `title` | <code>const&nbsp;string</code> |  | 腳本的標題。當不使用 `shorttitle` 參數時，它會顯示在圖表上，並在發佈腳本時成為出版物的默認標題。 |
| `shorttitle` | <code>const&nbsp;string</code> | `na` | 腳本在圖表上的顯示名稱。如果指定，它將替換大多數圖表相關窗口中的 `title` 參數。 |
...
| `timeframe` | <code>const&nbsp;string</code> | `na` | 向簡單腳本添加多時間範圍功能。 |
...
| `display` | <code>const&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/PlotDisplay">PlotDisplay</a></code> | `display.ALL` |  |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `title` | <code>const&nbsp;string</code> |  | 圖書館的標題及其標識符。它不能包含空格、特殊字符或以數字開頭。它用作出版物的默認標題，並在另一個腳本使用它時在 `import` 語句中唯一標識該庫。它也用作圖表上的腳本名稱。 |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `source` | <code>color</code> |  | 要檢查的顏色值。 |
| `replacement` | <code>color</code> | `#000000` | 如果 `source` 是 `na`，則傳回值。默認為#000000。 |
...
| `title` | <code>const&nbsp;string</code> | `na` | 繪圖的標題，顯示在樣式對話框中並作為資料窗口工具提示。 |
| `color` | <code>series&nbsp;color</code> | `color.BLUE` | 繪製元素的顏色。 |
| `linewidth` | <code>input&nbsp;int</code> | `1` | 繪製線的寬度，以像素為單位 (1-4)。 |
...
| `display` | <code>input&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/PlotDisplay">PlotDisplay</a></code> | `display.ALL` | 控制繪圖的顯示位置。使用 <code>display.all</code>、<code>display.none</code>、<code>display.pane</code>、<code>display.price_scale</code> 等。 |
...
| `linestyle` | <code>input&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/PlotStyle">PlotStyle</a></code> | `PlotStyle.Line` | 線條樣式：<a class="stdlib-ref" data-key="prelude::PlotStyle" href="/zh-HK/api/stdlib/prelude/PlotStyle">PlotStyle.Line</a>、<a class="stdlib-ref" data-key="prelude::PlotStyle" href="/zh-HK/api/stdlib/prelude/PlotStyle">PlotStyle.Line</a>、<a class="stdlib-ref" data-key="prelude::PlotStyle" href="/zh-HK/api/stdlib/prelude/PlotStyle">PlotStyle.Line</a>。 |
...
| `title` | <code>const&nbsp;string</code> | `na` | 標題顯示在樣式對話框和資料窗口中。 |
| `color_up` | <code>series&nbsp;color</code> | `color.BLUE` | 向上箭頭的顏色。 |
| `color_down` | <code>series&nbsp;color</code> | `color.BLACK` | 向下箭頭的顏色。 |
...
| `display` | <code>input&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/PlotDisplay">PlotDisplay</a></code> | `display.ALL` | 控制箭頭的顯示位置。 |
...
| `title` | <code>const&nbsp;string</code> | `na` | 標題顯示在樣式對話框和資料窗口中。 |
| `color` | <code>series&nbsp;color</code> | `color.BLUE` | 條形顏色。 |
| `editable` | <code>input&nbsp;bool</code> | `true` | 如果為 true，則可以在樣式對話框中編輯繪圖。 |
| `show_last` | <code>input&nbsp;int</code> | `na` | 如果設定，則僅顯示最後 N 個 bars。 |
| `display` | <code>input&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/PlotDisplay">PlotDisplay</a></code> | `display.ALL` | 控制 bars 的顯示位置。 |
| `format` | <code>input&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/Format">Format</a></code> | `na` | 覆蓋資料窗口中的默認數字格式。 |
| `precision` | <code>input&nbsp;int</code> | `na` | 顯示的小數位數。 |
| `force_overlay` | <code>const&nbsp;bool</code> | `na` | 如果為 true，力將顯示在主圖表窗格上。 |
...
| `title` | <code>const&nbsp;string</code> | `na` | 標題顯示在樣式對話框和資料窗口中。 |
| `color` | <code>series&nbsp;color</code> | `color.BLUE` | 蠟燭體顏色。 |
| `wick_color` | <code>series&nbsp;color</code> | `color.BLUE` | 燭芯顏色。 |
| `editable` | <code>input&nbsp;bool</code> | `true` | 如果為 true，則可以在樣式對話框中編輯繪圖。 |
| `show_last` | <code>input&nbsp;int</code> | `na` | 如果設定，則僅顯示最後 N 根蠟燭。 |
| `border_color` | <code>series&nbsp;color</code> | `color.BLACK` | 蠟燭體邊框顏色。 |
| `display` | <code>input&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/PlotDisplay">PlotDisplay</a></code> | `display.ALL` | 控制蠟燭的顯示位置。 |
| `format` | <code>input&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/Format">Format</a></code> | `na` | 覆蓋資料窗口中的默認數字格式。 |
| `precision` | <code>input&nbsp;int</code> | `na` | 顯示的小數位數。 |
| `force_overlay` | <code>const&nbsp;bool</code> | `na` | 如果為 true，力將顯示在主圖表窗格上。 |
...
| `title` | <code>const&nbsp;string</code> | `na` | 標題顯示在樣式對話框和資料窗口中。 |
| `char` | <code>input&nbsp;string</code> | `"⭐"` | 要顯示的字符（支持 Unicode）。 |
...
| `color` | <code>series&nbsp;color</code> | `color.BLUE` | 人物顏色。 |
| `offset` | <code>simple&nbsp;int</code> | `0` | 將字符向左（負）或右（正）移動 bars。 |
| `text` | <code>const&nbsp;string</code> | `na` | 顯示在角色附近的可選文本。 |
| `text_color` | <code>series&nbsp;color</code> | `color.BLUE` | 可選文本的顏色。 |
| `editable` | <code>input&nbsp;bool</code> | `true` | 如果為 true，則可以在樣式對話框中編輯繪圖。 |
...
| `display` | <code>input&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/PlotDisplay">PlotDisplay</a></code> | `display.ALL` | 控制字符的顯示位置。 |
| `format` | <code>input&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/Format">Format</a></code> | `na` | 覆蓋資料窗口中的默認數字格式。 |
| `precision` | <code>input&nbsp;int</code> | `na` | 顯示的小數位數。 |
| `force_overlay` | <code>const&nbsp;bool</code> | `na` | 如果為 true，力將顯示在主圖表窗格上。 |
...
| `location` | <code>input&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/Location">Location</a></code> | `Location.AboveBar` | 垂直位置：<code>location.abovebar</code>、<code>location.belowbar</code>、<code>location.top</code>、<code>location.bottom</code>、<code>location.absolute</code>。 |
| `color` | <code>series&nbsp;color</code> | `color.BLUE` | 形狀顏色。 |
| `offset` | <code>simple&nbsp;int</code> | `0` | 將形狀向左（負）或右（正）移動 bars。 |
| `text` | <code>const&nbsp;string</code> | `na` | 形狀附近顯示的可選文本。 |
| `text_color` | <code>series&nbsp;color</code> | `color.BLUE` | 可選文本的顏色。 |
| `editable` | <code>input&nbsp;bool</code> | `true` | 如果為 true，則可以在樣式對話框中編輯繪圖。 |
...
| `display` | <code>input&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/PlotDisplay">PlotDisplay</a></code> | `display.ALL` | 控制形狀的顯示位置。 |
| `format` | <code>input&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/Format">Format</a></code> | `na` | 覆蓋資料窗口中的默認數字格式。 |
| `precision` | <code>input&nbsp;int</code> | `na` | 顯示的小數位數。 |
| `force_overlay` | <code>const&nbsp;bool</code> | `na` | 如果為 true，力將顯示在主圖表窗格上。 |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `title` | <code>const&nbsp;string</code> |  | 腳本的標題。未設定 `shorttitle` 時顯示在圖表上，併成為發佈時的默認標題。 |
| `shorttitle` | <code>const&nbsp;string</code> | `na` | 圖表和大多數圖表相關窗口中顯示的腳本的縮寫顯示名稱。選修的。 |
...
| `currency` | <code>simple&nbsp;string</code> | `syminfo.currency` | 策略跟蹤資本、利潤和損失所用的基礎貨幣。選修的。默認為圖表符號的貨幣。 |
...
| `close_entries_rule` | <code>const&nbsp;string</code> | `"FIFO"` | 關閉多個打開的條目時應用的排序規則。 `\"FIFO` 首先關閉最舊的條目； `ANY` 允許關閉調用通過 ID 定位特定條目。選修的。默認為 `FIFO\"`。 |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `timeframe` | <code>series&nbsp;string</code> |  | 時間範圍代碼，例如 `\"D`、`60` 或 `W\"`。 |
| `session` | <code>series&nbsp;string</code> | `na` | 可選的會話窗口。省略時，將使用交易品種的常規會話規則。 |
| `timezone` | <code>series&nbsp;string</code> | `syminfo.timezone` | 評估會話字符串時使用的時區。 |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `timeframe` | <code>series&nbsp;string</code> |  | 目的地時間範圍。空字符串回落至圖表時間範圍。 |
| `session` | <code>series&nbsp;string</code> | `na` | 用於目標查找的可選會話過濾器。 |
...
| --- | --- | --- | --- |
| `timeframe` | <code>series&nbsp;string</code> |  | 時間範圍代碼，例如 `\"D`、`60` 或 `W\"`。 |
| `session` | <code>series&nbsp;string</code> | `na` | 查找過程中使用的可選會話窗口。 |
| `timezone` | <code>series&nbsp;string</code> | `syminfo.timezone` | 解釋會話字符串時使用的時區。 |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `date_string` | <code>string</code> |  | 要解析的日期/時間字符串。 |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `timezone` | <code>string</code> | `syminfo.timezone` | 時區（例如“America/New_York”、“UTC”、“GMT+8”）。 |
| `year` | <code>int</code> |  | 年份（例如 2024 年）。 |
| `month` | <code>int</code> |  | 月份（1-12）。 |
| `day` | <code>int</code> |  | 一個月中的某一天 (1-31)。 |
| `hour` | <code>int</code> | `0` | 小時 (0-23)。默認為 0。 |
