...
- [变量与限定符](/zh-CN/guide/types-and-variables) — 类型限定符、var/varip、na 处理
- [历史引用](/zh-CN/guide/history-reference) — 用 `[]` 访问过去 K 线的值
- [集合类型](/zh-CN/guide/collections) — array、map、matrix
