...
function wasm_bindgen__convert__closures_____invoke__h0231d76fbad5ce36(arg0, arg1) {
    wasm.wasm_bindgen__convert__closures_____invoke__h0231d76fbad5ce36(arg0, arg1);
}
...
export class Chart {
    ...
    /**
     * Forward a mouse-down event.
     *
     * Returns `true` if the chart consumed the event (e.g. an annotation
     * was hit-tested and selected), in which case the host should suppress
     * its own mouse-down handling.
     * @param {number} x
     * @param {number} y
     * @param {number} mods
     * @returns {boolean}
     */
    onMouseDown(x, y, mods) {
        const ret = wasm.chart_onMouseDown(this.__wbg_ptr, x, y, mods);
        return ret !== 0;
    }
    /**
     * Forward a pointer-move event to update the crosshair.
     *
     * `mods` is a bitfield: `CTRL=1, SHIFT=2, ALT=4, META=8`.
     * @param {number} x
     * @param {number} y
     * @param {number} mods
     */
    onMouseMove(x, y, mods) {
        wasm.chart_onMouseMove(this.__wbg_ptr, x, y, mods);
    }
    /**
     ...
     */
    onMouseEnter() {
        wasm.chart_onMouseEnter(this.__wbg_ptr);
    }
    /**
     * Handle the pointer leaving the canvas.
     *
     * Cancels any in-progress pan drag (seeding inertia) and hides the
     * crosshair.
     */
    onMouseLeave() {
        wasm.chart_onMouseLeave(this.__wbg_ptr);
    }
    /**
    ...
    /**
     * Forward a right-click (context-menu request).
     *
     * Returns `true` if the chart consumed the event; the host should call
     * `event.preventDefault()` when this returns `true`. Poll
     * [`pollEvent`](Self::pollEvent) for a `contextMenuRequested` event that
     * carries the menu items to display.
     * @param {number} x
     * @param {number} y
     * @returns {boolean}
     */
    onContextMenu(x, y) {
        const ret = wasm.chart_onContextMenu(this.__wbg_ptr, x, y);
        return ret !== 0;
    }
    /**
     * Forward a double-click at canvas coordinates `(x, y)`.
     * @param {number} x
     * @param {number} y
     */
    onDoubleClick(x, y) {
        wasm.chart_onDoubleClick(this.__wbg_ptr, x, y);
    }
    /**
    ...
    /**
     * Highlight the bar at `idx`, or pass `null` to clear the highlight.
     * @param {any} idx
     */
    setHighlightedBar(idx) {
        wasm.chart_setHighlightedBar(this.__wbg_ptr, idx);
    }
    /**
    ...
    /**
     * Forward a click at canvas coordinates `(x, y)`.
     * @param {number} x
     * @param {number} y
     */
    onClick(x, y) {
        wasm.chart_onClick(this.__wbg_ptr, x, y);
    }
    /**
     * Forward a wheel event to zoom the chart.
     *
     * `delta` is the raw `WheelEvent.deltaY` value; `mouseX` is the
     * canvas-relative X coordinate used as the zoom anchor.
     * @param {number} delta
     * @param {number} mouse_x
     */
    onWheel(delta, mouse_x) {
        wasm.chart_onWheel(this.__wbg_ptr, delta, mouse_x);
    }
    /**
    ...
    /**
     * Forward a mouse-up event to end any in-progress drag or resize.
     */
    onMouseUp() {
        wasm.chart_onMouseUp(this.__wbg_ptr);
    }
    /**
 ...
 * [`AnnotationImage`](openpine_chart::annotation::AnnotationImage)) to loaded
 * `HtmlImageElement`s.
 *
...
/**
 * In-process chart provider backed by the OpenPine VM.
 *
 * ```typescript
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_candlesticks_bb60cb8f1c79dd69 = function() { return handleError(function (arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
    ...
    imports.wbg.__wbg_chartStream_7e3061f05299caee = function() { return handleError(function (arg0, arg1, arg2, arg3, arg4, arg5) {
    ...
    imports.wbg.__wbg_currencyRate_ebc748d64477286a = function() { return handleError(function (arg0, arg1, arg2, arg3, arg4, arg5) {
        const ret = arg0.currencyRate(getStringFromWasm0(arg1, arg2), getStringFromWasm0(arg3, arg4), arg5);
        return ret;
    }, arguments) };
    imports.wbg.__wbg_data_240c04146710924a = function() { return handleError(function (arg0, arg1, arg2, arg3, arg4) {
    ...
    imports.wbg.__wbg_dividends_cc691f59d00409a8 = function() { return handleError(function (arg0, arg1, arg2, arg3, arg4, arg5) {
    ...
    imports.wbg.__wbg_earnings_f228f654f1d18c01 = function() { return handleError(function (arg0, arg1, arg2, arg3, arg4, arg5) {
        const ret = arg0.earnings(getStringFromWasm0(arg1, arg2), arg3, arg4, arg5);
        return ret;
    }, arguments) };
    imports.wbg.__wbg_economic_931d00cdcd8f20b7 = function() { return handleError(function (arg0, arg1, arg2, arg3, arg4, arg5) {
    ...
    imports.wbg.__wbg_financial_d53af31e39f2e165 = function() { return handleError(function (arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) {
    ...
    imports.wbg.__wbg_historyBarsBefore_d96efd341c52a161 = function() { return handleError(function (arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
    ...
    imports.wbg.__wbg_splits_6ff566e27d955520 = function() { return handleError(function (arg0, arg1, arg2, arg3, arg4) {
    ...
    imports.wbg.__wbg_symbolInfo_fb6495d48ff71b56 = function() { return handleError(function (arg0, arg1, arg2, arg3) {
    ...
    imports.wbg.__wbg_ticks_d03000b46a2b0302 = function() { return handleError(function (arg0, arg1, arg2, arg3, arg4) {
    ...
    imports.wbg.__wbindgen_cast_2c2f0f6b9777848c = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 862, function: Function { arguments: [], shim_idx: 805, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, wasm.wasm_bindgen__closure__destroy__h3eff321b93ad5908, wasm_bindgen__convert__closures_____invoke__h0231d76fbad5ce36);
        return ret;
    };
    ...
    imports.wbg.__wbindgen_cast_e7d1933deda674d4 = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('openpine_chart_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
