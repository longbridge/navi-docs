...
/**
 * Resolves `import` statements in Navi Script source code.
 *
...
export interface LibraryLoader {
  /** Return the Pine source for `path`, or `null` if not found. */
...
/** Metadata for a single `input.*()` declaration in an Navi Script. */
...
export class Chart {
   ...
   */
  setHighlightedBar(idx: any): void;
  /**
   ...
   */
  onWheel(delta: number, mouse_x: number): void;
  /**
...
export interface InitOutput {
  ...
  readonly chart_onClick: (a: number, b: number, c: number) => void;
  readonly chart_onContextMenu: (a: number, b: number, c: number) => number;
  readonly chart_onDoubleClick: (a: number, b: number, c: number) => void;
  readonly chart_onMouseDown: (a: number, b: number, c: number, d: number) => number;
  readonly chart_onMouseEnter: (a: number) => void;
  readonly chart_onMouseLeave: (a: number) => void;
  readonly chart_onMouseMove: (a: number, b: number, c: number, d: number) => void;
  readonly chart_onMouseUp: (a: number) => void;
  ...
  readonly chart_setHighlightedBar: (a: number, b: any) => void;
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h0231d76fbad5ce36: (a: number, b: number) => void;
  readonly wasm_bindgen__closure__destroy__h3eff321b93ad5908: (a: number, b: number) => void;
